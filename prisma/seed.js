...
function genCalendar(start, numDays, fn) {
  ...
  for (let i = 0; i < numDays; i++) {
    ...
    days.push({ date: date.toISOString().slice(0, 10), count: Math.max(0, Math.round(fn(i, date))) });
  }
  return days;
}
...
const MEMBERS = [
  {
    ...
    counts: { totalCommits: 480, totalPRs: 40, mergedPRs: 22, reviewsGiven: 9, issuesOpened: 14, followers: 120, totalStars: 60, repoCount: 25, contributedRepoCount: 30, languageCount: 4 },
    topLanguages: [{ name: 'Python', bytes: 900000 }, { name: 'C', bytes: 400000 }, { name: 'Assembly', bytes: 120000 }, { name: 'Shell', bytes: 40000 }],
  ...
  },
  {
    ...
    counts: { totalCommits: 300, totalPRs: 25, mergedPRs: 40, reviewsGiven: 30, issuesOpened: 10, followers: 900, totalStars: 1500, repoCount: 80, contributedRepoCount: 60, languageCount: 6 },
    topLanguages: [{ name: 'C', bytes: 5000000 }, { name: 'Shell', bytes: 300000 }, { name: 'Assembly', bytes: 200000 }, { name: 'Perl', bytes: 90000 }, { name: 'Makefile', bytes: 60000 }],
  ...
  },
  {
    ...
    counts: { totalCommits: 220, totalPRs: 30, mergedPRs: 12, reviewsGiven: 40, issuesOpened: 20, followers: 200, totalStars: 45, repoCount: 18, contributedRepoCount: 25, languageCount: 7 },
    topLanguages: [{ name: 'COBOL', bytes: 700000 }, { name: 'Go', bytes: 500000 }, { name: 'Rust', bytes: 300000 }, { name: 'TypeScript', bytes: 200000 }, { name: 'Python', bytes: 100000 }],
    nightCommitRatio: null,
  ...
  },
  {
    ...
    counts: { totalCommits: 260, totalPRs: 60, mergedPRs: 55, reviewsGiven: 15, issuesOpened: 25, followers: 80, totalStars: 20, repoCount: 22, contributedRepoCount: 70, languageCount: 5 },
    topLanguages: [{ name: 'Haskell', bytes: 600000 }, { name: 'Python', bytes: 300000 }, { name: 'C++', bytes: 250000 }, { name: 'Lean', bytes: 100000 }, { name: 'TeX', bytes: 50000 }],
    nightCommitRatio: null,
  ...
  },
  {
    ...
    counts: { totalCommits: 140, totalPRs: 12, mergedPRs: 6, reviewsGiven: 6, issuesOpened: 8, followers: 60, totalStars: 12, repoCount: 10, contributedRepoCount: 15, languageCount: 3 },
    topLanguages: [{ name: 'Assembly', bytes: 400000 }, { name: 'C', bytes: 200000 }, { name: 'Fortran', bytes: 80000 }],
  ...
  },
  {
    ...
    counts: { totalCommits: 18, totalPRs: 1, mergedPRs: 1, reviewsGiven: 0, issuesOpened: 2, followers: 5, totalStars: 1, repoCount: 3, contributedRepoCount: 2, languageCount: 2 },
    topLanguages: [{ name: 'Python', bytes: 40000 }, { name: 'Jupyter Notebook', bytes: 20000 }],
    nightCommitRatio: null,
